...
Create two new files called `spike.siege` and `maxload.siege` in the root directory of the project:
```bash
/NaviSafe.Tests/StressTests
```
...
**-c** specifies the number of concurrent users, and **-t** specifies the duration of the test. To increase the concurrent users, simply change the value of **-c** between 0 and 300.
