...
**-c** specifies the number of concurrent users, and **-t** specifies the duration of the test. To increase the concurrent users, simply change the value of **-c** between 1 and 300.
